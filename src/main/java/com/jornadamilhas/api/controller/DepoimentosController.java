...
public class DepoimentosController {
    ...
    @PostMapping
    public ResponseEntity<Depoimento> cadastrar(@ModelAttribute DadosCadastroDepoimento dados, UriComponentsBuilder uriBuilder) throws IOException {
    ...
    @PutMapping
    @Transactional
    public ResponseEntity<DadosDetalhamentoDepoimento> atualizar(@ModelAttribute DadosAtualizacaoDepoimento dados) {
